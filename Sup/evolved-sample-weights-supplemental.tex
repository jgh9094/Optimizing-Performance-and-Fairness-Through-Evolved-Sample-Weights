...
\urlstyle{same}
\hypersetup{
  pdftitle={Supplemental Material for `Optimizing Model Performance and Fairness Through Genetically Evolved Sample Weights'},
...
\includegraphics[width=1\linewidth]{evolved-sample-weights-supplemental_files/figure-latex/per-hv-plt-1}
...
\includegraphics[width=1\linewidth]{evolved-sample-weights-supplemental_files/figure-latex/ppr-hv-plt-1}
